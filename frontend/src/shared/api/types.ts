...
export type ReportResume = S["ReportResumeV1"];
export type BreakdownSelection = S["BreakdownSelectionV1"];
...
export type AdminSavings = S["AdminSavingsV1"];
export type AdminTokenPeriod = S["AdminTokenPeriodV1"];
export type AdminActiveUsersPeriod = S["AdminActiveUsersPeriodV1"];
export type AdminReportPage = S["AdminReportPageV1"];
export type AdminRange = S["AdminRangeV1"];
