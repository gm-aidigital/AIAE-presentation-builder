...
class PlaceholderLabelCollectorImplTest {
    ...
    void shouldCollectLabelChipsFromSheetAndAdjustmentsTest() {
        ...
        PlaceholderResolverService.Labels labels = collector.collectAllLabels(payload);

        assertThat(labels.sheet()).containsExactly(new PlaceholderResolverService.LabelChip("Client name:", "Acme"));
        assertThat(labels.adj()).containsExactly(new PlaceholderResolverService.LabelChip("Audience age:", "25-34"));
    }
}
