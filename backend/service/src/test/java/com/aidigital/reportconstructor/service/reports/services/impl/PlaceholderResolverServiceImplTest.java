...
class PlaceholderResolverServiceImplTest {
    ...
    @Mock CampaignDataCollector campaignDataCollector;
    @Mock PlaceholderSectionBuilder sectionBuilder;
    @Mock PlaceholderClaudeGate claudeGate;
    @Mock PlaceholderLabelCollector labelCollector;
    @Mock PlaceholderValueFlattener valueFlattener;
    @Mock ReportClaudeDefaults claudeDefaults;

    @InjectMocks PlaceholderResolverServiceImpl service;
    ...
    void shouldCountResolvedAndTotalPlaceholdersForPreviewTest() {
        ...
        when(labelCollector.collectAllLabels(payload))
            .thenReturn(new PlaceholderResolverService.Labels(List.of(), List.of()));

        PlaceholderResolverService.PreviewResult result = service.resolve(payload);
