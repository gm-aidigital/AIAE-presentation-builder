...
class PlaceholderResolverServiceImplTest {
	...
	void shouldCountResolvedAndTotalPlaceholdersForPreviewTest() {
		...
		when(sectionBuilder.buildSections(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), anyInt()))
	...
	void shouldFlattenBuiltSectionsForReplacementsTest() {
		...
		when(sectionBuilder.buildSections(any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), any(), anyInt())).thenReturn(sections);
		when(valueFlattener.buildFlatReplacements(sections)).thenReturn(flat);

		Map<String, String> result = service.buildFlatReplacements(payload, null, null, null, null, null, null, null, null, null, null, 28);
