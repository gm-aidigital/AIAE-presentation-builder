 ...
 * to 5 elements; {@code tacticOverviews} is keyed by 1-based tactic number;
 ...
 * @param thoughtsOnPerformance up to 5 Claude-generated entries in slide order: four performance commentary
 *                              bullets, then the campaign story that fills
 *                              {@code {{thoughts on the performance 5}}}
