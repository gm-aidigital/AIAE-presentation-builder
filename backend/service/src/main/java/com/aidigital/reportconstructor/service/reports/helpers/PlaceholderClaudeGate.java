...
public interface PlaceholderClaudeGate {
	...
	/**
	 * Returns true when the funnel-stage summary must be generated from the workbook: no manual funnel
	 * value is present and the media-plan funnel/goal column is absent.
	 *
	 * @param payload constructor request whose adjustments and sheet rows are inspected
	 * @return {@code true} when the funnel-stage summary AI call is required
	 */
