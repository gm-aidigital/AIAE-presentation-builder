 ...
 * in-memory Step-2 {@link TacticConclusion} outputs — no sheet re-read. It bridges Step 2 to Step 3 (the
 * per-tactic thoughts call) and Step 4 (the campaign-level results call), so both consume the same
