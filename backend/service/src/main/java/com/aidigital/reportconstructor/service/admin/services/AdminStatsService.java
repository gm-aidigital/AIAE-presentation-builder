...
public interface AdminStatsService {
	 ...
	 * @param from        first day to report on, or {@code null} to use the default window
	 * @param to          last day to report on, or {@code null} for today
	 ...
	 */
	AdminStats statsFor(String callerEmail, LocalDate from, LocalDate to);
}
